...
Параметры TAKER_FEE_PCT (0.09%) и MAKER_FEE_PCT (0.0324%) в risk_gate.py -
ИЗМЕРЕНЫ на реальном счету Али (скриншот "Мои комиссии", со скидкой MNT
10%) - если скидка MNT когда-нибудь отключится, ставки вырастут до
0.10%/0.036% и константы нужно будет обновить.
